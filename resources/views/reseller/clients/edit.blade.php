...
<div class="py-8">
    <div class="max-w-md mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Client</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            <form action="{{ route('reseller.clients.update', $client) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-4">
                    <label for="username" class="block text-gray-700 dark:text-gray-300 mb-2">Username</label>
                    <input type="text" name="username" id="username" value="{{ old('username', $client->username) }}" 
                ...
                <div class="mb-4">
                    <label for="password" class="block text-gray-700 dark:text-gray-300 mb-2">Password (Leave blank to keep current)</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="expires_at" id="expires_at" value="{{ old('expires_at', $client->expires_at ? $client->expires_at->format('Y-m-d') : '') }}" 
                ...
                <div class="mb-6">
                    <label for="active" class="flex items-center text-gray-700 dark:text-gray-300">
                        <input type="checkbox" name="active" id="active" value="1" class="mr-2 rounded border-gray-300 dark:border-gray-700 text-purple-600 focus:ring-purple-500 dark:bg-gray-700" 

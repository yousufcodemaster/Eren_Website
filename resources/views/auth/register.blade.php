<x-guest-layout>
    ...
    <div class="mb-6">
        <a href="{{ route('discord.login') }}" class="flex w-full items-center justify-center rounded-lg bg-[#5865F2] px-4 py-3 text-white hover:bg-[#4752c4] focus:outline-none focus:ring-2 focus:ring-[#5865F2] focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all duration-200 shadow-lg">
            <svg class="h-5 w-5 mr-3" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="my-6 flex items-center justify-center">
        <div class="border-t border-purple-300/30 flex-grow"></div>
        <div class="mx-4 text-sm text-purple-200">Or register with email</div>
        <div class="border-t border-purple-300/30 flex-grow"></div>
    </div>
